...
{{-- =========================================================
     MAIN NAVIGATION
     NOT STICKY — SCROLLS AWAY WITH PAGE
========================================================= --}}
...
>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="h-[82px] flex items-center justify-between">
            ...
            <a
                href="{{ route('home') }}"
                class="flex items-center shrink-0 focus:outline-none"
            >
            ...
            <div class="hidden lg:flex items-center gap-6 xl:gap-7">
                ...
                <a
                    href="{{ route('home') }}"
                    class="relative text-[15px] font-medium text-gray-800
                           hover:text-[#073B66]
